<?php
	...
	if(isset($_GET["residentID"])){
		...
		if(!$result = $db->query("SELECT tblList.listID, listName, residentID1, residentID2, residentID3, residentID4 FROM tblList WHERE residentID1 = $residentID OR residentID2 = $residentID OR residentID3 = $residentID OR residentID4 = $residentID")){
